"""RVV matmul cocotb: 32x16 x 16x32 -> 32x32 only."""
...
@cocotb.test()
async def core_mini_rvv_matmul_32x16_16x32_test(dut):
    """Matmul int8: LHS 32x16 times RHS 16x32 -> 32x32 (RHS column-major in ELF)."""
    ...
    await _rvv_matmul_mlops_case(
        ...
        inner=16,
        rhs_cols=32,
        elf_files=['rvv_matmul_32x16_16x32.elf'],
        case_tag='32x16x32',
    )
