"""RVV matmul cocotb: 16x32 x 32x16 -> 16x16 only."""
...
@cocotb.test()
async def core_mini_rvv_matmul_16x32_32x16_test(dut):
    """Matmul int8: LHS 16x32 times RHS 32x16 -> 16x16 (RHS column-major in ELF)."""
    ...
    await _rvv_matmul_mlops_case(
        ...
        inner=32,
        rhs_cols=16,
        elf_files=['rvv_matmul_16x32_32x16.elf'],
        case_tag='16x32x16',
    )
